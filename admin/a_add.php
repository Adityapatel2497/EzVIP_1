	...
	<hr>
				...
				<form action="insert.php" method="POST" >
					<table align="center">
						...
						<tr><td class="td" align="center"> DOB :*</td><td><input type="text" id="datepicker" data-formate="dd-mm-yyyy" placeholder="Enter DOB (dd-mm-yyyy)." name="dob" autocomplete="no" required></input></td></tr>
						...
						<td><input type="radio" name="type" value="v">Vendor</input>&nbsp;&nbsp;<input type="radio" name="type" value="e">Employee</input>
						</td></tr>
